...
namespace UIWidgets
{
	...
	public class ListView : ListViewBase {
		...
		{
			return !CommentsStartWith.Any(comment => str.StartsWith(comment, StringComparison.InvariantCulture));
		}
		...
		{
			return bottomHiddenItems * GetItemSize() - GetItemSpacing();
		}
		...
		{
			return topHiddenItems * GetItemSize() - GetItemSpacing();
		}

		/// <summary>
		/// Updates the bottom filler.
		/// </summary>
		void UpdateBottomFiller()
		{
			...
			else
			{
				...
				bottomFiller.sizeDelta = (IsHorizontal())
					? new Vector2(CalculateBottomFillerSize(), bottomFiller.sizeDelta.y)
					: new Vector2(bottomFiller.sizeDelta.x, CalculateBottomFillerSize());
			}
		}

		/// <summary>
		/// Updates the top filler.
		/// </summary>
		void UpdateTopFiller()
		{
			...
			else
			{
				...
				topFiller.sizeDelta = (IsHorizontal())
					? new Vector2(CalculateTopFillerSize(), bottomFiller.sizeDelta.y)
					: new Vector2(bottomFiller.sizeDelta.x, CalculateTopFillerSize());
			}
		}
